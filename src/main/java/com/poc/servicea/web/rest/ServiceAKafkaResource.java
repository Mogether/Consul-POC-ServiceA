...
@RestController
@RequestMapping("/api/service-a-kafka")
public class ServiceAKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ServiceAKafkaResource.class);
    ...
    public ServiceAKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
